...
For example the Local Ensemble Transform Klaman Filter~\citep{Bocquet2020Online} provides state-of-the-art performance in high-dimensional fitlering an system identification settings, and could be adapted to the Matheron update.
