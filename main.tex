...
\begin{figure}[t]
  \centering
  \includegraphics[width=.48\linewidth]{figures/perf_scaling_obs.pdf}
  \includegraphics[width=.48\linewidth]{figures/perf_scaling_dim.pdf}
  \caption{Left: wall-clock vs observations ($d=2000$).%
           Right: wall-clock vs state dimension ($m=2000$).}
